...
### Прогресс задач:
- [ ] **Задача 1.1:** Prisma схема и миграции (0%)
...
### Следующий шаг:
**Создать feature ветку и начать с Prisma схемы:**
```bash
...
**Следующие шаги:**
1. Создать `feature/db-core-privacy` ветку
2. Начать с Prisma схемы (8 таблиц)
3. Применить миграции
4. Реализовать сессии и API
